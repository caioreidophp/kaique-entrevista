...
export default function VacationsDashboardPage() {
    ...
    const [timelineEditDraft, setTimelineEditDraft] =
        useState<TimelineEditDraft | null>(null);
    const [hoveredAbonoSlice, setHoveredAbonoSlice] = useState<number | null>(
        null,
    );
    ...
    const abonoDonutData = useMemo(() => {
        ...
        const totalLancamentos =
            data?.total_lancamentos_abono ?? totalComAbono + totalSemAbono;
        ...
        data?.total_com_abono,
        data?.total_lancamentos_abono,
        data?.total_sem_abono,
    ]);

    const activeAbonoSlice =
        hoveredAbonoSlice !== null ? abonoDonutData[hoveredAbonoSlice] : null;
    const maxRiskScore = Math.max(
        1,
        ...(data?.riscos_por_unidade ?? []).map((item) => item.risk_score),
    );
    ...
    function openTimelineEdit(
        item: VacationDashboard['timeline'][number],
    ): void {
                ...
                if (error instanceof ApiError) {
                    ...
                    setNotification({
                        message:
                            firstError ??
                            error.message ??
                            'Não foi possível salvar a edição de férias.',
                        variant: 'error',
                    });
                ...
                <div className="transport-dashboard-header flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                    <div>
                        ...
                        <h2 className="transport-dashboard-title">
                            Controle de Férias - Dashboard
                        </h2>
                        <p className="transport-dashboard-subtitle">
                            Visão de vencimentos, timeline de férias e
                    ...
                    <div className="w-full max-w-xs">
                        <p className="mb-1 text-xs text-muted-foreground">
                            Filtro da dashboard por unidade
                        </p>
                        <Select
                            value={selectedUnit}
                        ...
                        <div className="grid gap-4 md:grid-cols-3 xl:grid-cols-6">
                            ...
                            <Card className="transport-metric-card transport-tone-success">
                                ...
                                <CardContent>
                                    <p className="transport-metric-value">
                                        {formatPercentBR(
                                            data?.taxa_liberadas_sobre_ativos ??
                                                0,
                                        )}
                                    </p>
                                </CardContent>
                            ...
                            <Card className="transport-insight-card">
                                <CardHeader>
                                    ...
                                    <p className="transport-dashboard-section-subtitle">
                                        Vigentes, agendadas e passadas com
                                ...
                                <CardContent>
                                    {timelineGraph ? (
                                                    ...
                                                    <div className="relative h-9">
                                                        ...
                                                        {timelineGraph.hasTodayMarker ? (
                                                            <div
                                                                ...
                                                                style={{
                                                                    left: `${timelineGraph.todayLeftPercent}%`,
                                                                }}
                                                            >
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Sem férias vigentes ou agendadas
                                            para a timeline.
                                        </p>
                                    )}
                                </CardContent>
                            ...
                            <Card className="transport-insight-card">
                                <CardHeader>
                                    ...
                                    <p className="transport-dashboard-section-subtitle">
                                        Total lançado:{' '}
                                        {formatIntegerBR(
                                            data?.total_lancamentos_abono ?? 0,
                                        )}{' '}
                                        férias
                                    </p>
                                </CardHeader>
                                                ...
                                                <div className="relative h-48 w-48">
                                                    ...
                                                    <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center text-center">
                                                        <p className="max-w-[110px] px-2 text-[10px] leading-tight text-muted-foreground">
                                                            {activeAbonoSlice
                                                                ? activeAbonoSlice.label
                                                                : 'Com abono'}
                                                        </p>
                                                        <p className="text-sm font-semibold md:text-base">
                                                            {formatPercentBR(
                                                                activeAbonoSlice
                                                                    ? activeAbonoSlice.percentual
                                                                    : (data?.percentual_com_abono ??
                                                                          0),
                                                            )}
                                                        </p>
                        ...
                        <div className="grid gap-4 xl:grid-cols-[1.1fr_1fr]">
                            <Card className="transport-insight-card">
                                <CardHeader>
                                    ...
                                    <p className="transport-dashboard-section-subtitle">
                                        Ranking de colaboradores com maior
                                        pressao de vencimento.
                                    </p>
                                </CardHeader>
                                <CardContent className="space-y-2">
                                    {data?.top_prioridades.length ? (
                                        data.top_prioridades.map(
                                            (item, index) => (
                                                <div
                                                    ...
                                                    <div className="flex items-center justify-between gap-2">
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            <span className="rounded-full bg-muted px-2 py-0.5 text-[10px] font-semibold text-muted-foreground">
                                                                D-
                                                                {formatIntegerBR(
                                                                    item.dias_para_limite,
                                                                )}
                                                            </span>
                                                            <span
                                                                className={`transport-status-badge ${priorityBadgeClass(item.status)}`}
                                                            >
                                                                {priorityStatusLabel(
                                                                    item.status,
                                                                )}
                            ...
                            <Card className="transport-insight-card">
                                <CardHeader>
                                    ...
                                    <p className="transport-dashboard-section-subtitle">
                                        Comparativo direto de criticidade entre
                                        unidades.
                                    </p>
                                </CardHeader>
                                <CardContent className="space-y-2">
                                    {data?.riscos_por_unidade.length ? (
                                        data.riscos_por_unidade
                                            .slice(0, 6)
                                            .map((item, index) => (
                                                <div
                                                    key={item.unidade_id}
                                                ...
                                                >
                                                    ...
                                                    <div className="transport-progress-track mt-2">
                                                        <div
                                                            ...
                                                            style={{
                                                                width: `${Math.min(100, Math.max(8, (item.risk_score / maxRiskScore) * 100))}%`,
                                                            }}
                                                        />
                                                    </div>
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Sem consolidado por unidade no
                                            período.
                                        </p>
                                    )}
                                </CardContent>
                        ...
                        <div className="grid gap-4 xl:grid-cols-[1.6fr_1fr]">
                            ...
                            <Card className="transport-insight-card">
                                <CardHeader>
                                    <CardTitle className="transport-dashboard-section-title">
                                        Férias vigentes (
                                        {data?.ferias_vigentes.length ?? 0})
                                    </CardTitle>
                                </CardHeader>
                                <CardContent>
                                    {data?.ferias_vigentes.length ? (
                                        <div className="max-h-[420px] space-y-2 overflow-auto pr-1">
                                            {data.ferias_vigentes.map(
                                                (item) => (
                                                    <div
                                                        key={item.id}
                                                        className="transport-list-panel"
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Não há férias vigentes no momento.
                                        </p>
                                    )}
                                </CardContent>
                            </Card>
                ...
                >
                    <DialogContent className="max-w-2xl">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Ajuste o lançamento selecionado e salve para
                        ...
                        <DialogFooter>
                            ...
                            <Button
                                ...
                                disabled={
                                    savingTimelineEdit || !timelineEditDraft
                                }
                            >
                                {savingTimelineEdit ? (
                                    <>
